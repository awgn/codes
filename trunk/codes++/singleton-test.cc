...
#define RESET   "\E[0m"
    ...
    test_1 & ref_1 = test_1::instance();
    test_2 & ref_2 = test_2::instance();
    test_3 & ref_3 = test_3::instance();
    test_4 & ref_4 = test_4::instance();
    test_5 & ref_5 = test_5::instance();
    test_6 & ref_6 = test_6::instance();
    test_7 & ref_7 = test_7::instance();
    test_8 & ref_8 = test_8::instance();
    test_9 & ref_9 = test_9::instance();

    const const_test_1 & const_ref_1 = const_test_1::instance();
    const const_test_2 & const_ref_2 = const_test_2::instance();
    const const_test_3 & const_ref_3 = const_test_3::instance();
    const const_test_4 & const_ref_4 = const_test_4::instance();
    const const_test_5 & const_ref_5 = const_test_5::instance();
    const const_test_6 & const_ref_6 = const_test_6::instance();
    const const_test_7 & const_ref_7 = const_test_7::instance();
    const const_test_8 & const_ref_8 = const_test_8::instance();
    const const_test_9 & const_ref_9 = const_test_9::instance();

    volatile volatile_test_1 & volatile_ref_1 = volatile_test_1::instance();
    volatile volatile_test_2 & volatile_ref_2 = volatile_test_2::instance();
    volatile volatile_test_3 & volatile_ref_3 = volatile_test_3::instance();
    volatile volatile_test_4 & volatile_ref_4 = volatile_test_4::instance();
    volatile volatile_test_5 & volatile_ref_5 = volatile_test_5::instance();
    volatile volatile_test_6 & volatile_ref_6 = volatile_test_6::instance();
    volatile volatile_test_7 & volatile_ref_7 = volatile_test_7::instance();
    volatile volatile_test_8 & volatile_ref_8 = volatile_test_8::instance();
    volatile volatile_test_9 & volatile_ref_9 = volatile_test_9::instance();

    ind_test_1 & ind_ref_1 = ind_test_1::instance();
    ind_test_2 & ind_ref_2 = ind_test_2::instance();
    ind_test_3 & ind_ref_3 = ind_test_3::instance();
    ind_test_4 & ind_ref_4 = ind_test_4::instance();
    ind_test_5 & ind_ref_5 = ind_test_5::instance();
    ind_test_6 & ind_ref_6 = ind_test_6::instance();
    ind_test_7 & ind_ref_7 = ind_test_7::instance();
    ind_test_8 & ind_ref_8 = ind_test_8::instance();
    ind_test_9 & ind_ref_9 = ind_test_9::instance();

    const ind_const_test_1 & ind_const_ref_1 = ind_const_test_1::instance();
    const ind_const_test_2 & ind_const_ref_2 = ind_const_test_2::instance();
    const ind_const_test_3 & ind_const_ref_3 = ind_const_test_3::instance();
    const ind_const_test_4 & ind_const_ref_4 = ind_const_test_4::instance();
    const ind_const_test_5 & ind_const_ref_5 = ind_const_test_5::instance();
    const ind_const_test_6 & ind_const_ref_6 = ind_const_test_6::instance();
    const ind_const_test_7 & ind_const_ref_7 = ind_const_test_7::instance();
    const ind_const_test_8 & ind_const_ref_8 = ind_const_test_8::instance();
    const ind_const_test_9 & ind_const_ref_9 = ind_const_test_9::instance();

    volatile ind_volatile_test_1 & ind_volatile_ref_1 = ind_volatile_test_1::instance();
    volatile ind_volatile_test_2 & ind_volatile_ref_2 = ind_volatile_test_2::instance();
    volatile ind_volatile_test_3 & ind_volatile_ref_3 = ind_volatile_test_3::instance();
    volatile ind_volatile_test_4 & ind_volatile_ref_4 = ind_volatile_test_4::instance();
    volatile ind_volatile_test_5 & ind_volatile_ref_5 = ind_volatile_test_5::instance();
    volatile ind_volatile_test_6 & ind_volatile_ref_6 = ind_volatile_test_6::instance();
    volatile ind_volatile_test_7 & ind_volatile_ref_7 = ind_volatile_test_7::instance();
    volatile ind_volatile_test_8 & ind_volatile_ref_8 = ind_volatile_test_8::instance();
    volatile ind_volatile_test_9 & ind_volatile_ref_9 = ind_volatile_test_9::instance();
