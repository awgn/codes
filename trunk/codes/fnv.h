...
extern Fnv32_t fnv_32a_iovec(const struct iovec *, size_t, Fnv32_t);
extern Fnv64_t fnv_64a_iovec(const struct iovec *, size_t, Fnv64_t);
extern Fnv32_t fnv_32a_file(const char *, Fnv32_t );
extern Fnv64_t fnv_64a_file(const char *, Fnv64_t );
